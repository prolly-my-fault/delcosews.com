        ...
        <div className="bg-background border border-delco-neutral-200 dark:border-delco-neutral-800 rounded-2xl shadow-lg p-12">
          ...
          <div className="space-y-4 text-lg leading-relaxed max-w-2xl mx-auto">
            <p className="text-foreground">
              ✨ When you have a vision and need someone to make it reality!
            </p>
            <p className="text-delco-neutral-600 dark:text-delco-neutral-400">
              From &quot;I saw this on Pinterest and fell in love&quot; to &quot;I have this wild idea,&quot; we specialize in bringing your sewing dreams to life. You dream it, we&apos;ll figure out how to sew it. Fair warning: may result in becoming the most stylish person in your friend group.
            </p>
          </div>
          
          <div className="mt-8">
            <a 
              href="mailto:info@delcosews.com?subject=Custom%20Sewing&body=Hi%20Andrea!%20I%20have%20a%20custom%20sewing%20project%20idea." 
