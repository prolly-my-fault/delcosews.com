        ...
        <div className="bg-background border border-delco-neutral-200 dark:border-delco-neutral-800 rounded-2xl shadow-lg p-12">
          ...
          <div className="space-y-4 text-lg leading-relaxed max-w-2xl mx-auto">
            <p className="text-foreground">
              👥 Because sewing is always better with friends (and witnesses to your victories)!
            </p>
            <p className="text-delco-neutral-600 dark:text-delco-neutral-400">
              From fabric swaps to show-and-tell sessions, we&apos;re planning gatherings that celebrate our shared obsession with all things sewn. Think book club, but with more pins and significantly more fabric hoarding.
            </p>
          </div>
          
          <div className="mt-8">
            <a 
              href="mailto:info@delcosews.com?subject=Community%20Events&body=Hi%20Andrea!%20I%27d%20love%20to%20join%20community%20events." 
